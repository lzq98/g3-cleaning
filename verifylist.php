    ...
    <section id="request" class="request">
        <div class="container">
            ...
            <form action="searchworker.php" method="get" role="form" class="php-request-form">
                ...
                $pendinglist = dbsearch("image", ['imageid', 'worker', 'date'], "reviewer", 0);

                if (count($pendinglist) == 0) {
                ?>
                <div class="row">
                    <div class="d-flex justify-content-center">
                        <a href="/index.php">No workers needs to be verified.</a>
                    </div>
                </div>
                <?php
                } else {
                ...
                <div class="row">
                    <div class="col-lg-12 d-flex align-items-center">
                        <table class="table table-hover">
                            ...
                            <?php
                    echo "<tbody>";
                    foreach ($pendinglist as $image) {
                        $link = "/viewcert.php?imageid=" . $image["imageid"];
                        echo '<tr onClick="window.location.href=\'' . $link . '\';">';
                        echo '<th scope="row">' . $image["imageid"] . '</th>';
                        echo '<td>' . $image["worker"] . '</td>';
